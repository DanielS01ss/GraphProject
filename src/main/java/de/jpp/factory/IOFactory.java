        ...
        GraphReader<XYNode, Double, TwoDimGraph, String> graph = new GraphReader<XYNode, Double, TwoDimGraph, String>() {
            ...
            public TwoDimGraph read(String input) {
                ...
                try (Scanner scanner = new Scanner(input)) {
                    ...
                    Pattern nodePattern1 = Pattern.compile("(\\s*)(([0-9]*){1})(\\s*).(\\s*)((label=((n[0-9]*)|(\\\"\\\"))){1})(\\s*)((x=((-?)(0|([1-9][0-9]*))(.[0-9]+)?)){1})(\\s*)((y=((-?)(0|([1-9][0-9]*))(.[0-9]+)?)){1})(\\s*).(\\s*)");
                    Pattern nodePattern2 = Pattern.compile("(\\s*)([0-9]*){1}(\\s*).(\\s*)((x=((-?)(0|([1-9][0-9]*))(.[0-9]+)?)){1})(\\s*)((y=((-?)(0|([1-9][0-9]*))(.[0-9]+)?)){1})(\\s*)((label=((n[0-9]*)|(\\\"\\\"))){1})(\\s*).(\\s*)");
                    ...
                    Pattern annoyingNodePattern = Pattern.compile("([0-9]*)(\\s*).((x=((-?)(0|([1-9][0-9]*))(.[0-9]+)?)){1})(\\s*)((y=((-?)(0|([1-9][0-9]*))(.[0-9]+)?)){1})(\\s*)((label=(.*)){1})(\\s*).|(([0-9]*){1})(\\s*).((label=(.*)){1})(\\s*)((x=((-?)(0|([1-9][0-9]*))(.[0-9]+)?)){1})(\\s*)((y=((-?)(0|([1-9][0-9]*))(.[0-9]+)?)){1})(\\s*).");
                    ...
                    while (scanner.hasNextLine()) {
                        ...
                        } else if (annoyingNodeMatcher.matches()) {
